...
const Navbar = () => {
  ...
  return (
    <div className=" items-center z-[100] bg-cyan-900 sticky top-0  gap-2  w-full  sm:flex-col   justify-between px-3 py-1 flex">
    <div className='flex sm:w-full items-center justify-between'>
      <div className='flex justify-center items-center'>
      <img className='w-[50px] aspect-square mix-blend-lighten' src={mainEvent.logo} alt="event logo"/>
    ...
    <ul id="navdrawer" className='flex sm:text-2xl z-[100] sm:h-[calc(100vh-4.5rem)]   sm:justify-center sm:items-center  gap-8 lg:text-xl xl:text-md sm:flex-col  font-poppins   sm:hidden  sm:text-center duration-500 transform md:text-center'>
