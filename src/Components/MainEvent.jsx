    ...
    <div className='w-[80%] sm:w-[95%] mx-auto text-center border-2 border-blue-400 rounded-2xl  bg-transparent'>
       ...
       <div className='flex sm:flex-col justify-center items-center gap-1'>
            ...
            <div className='w-[80%] flex flex-col gap-1 justify-center text-justify p-5 sm:p-0 items-center'>
              ...
              <p className='text-xl mt-2 text-red-200'>{mainEvent.description}</p>
              
              <div className='flex justify-end mt-5 gap-5'>
                  <a href="/avinya" type="button" className="text-white   bg-pink-600 hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">EVENT DETAILS</a>
